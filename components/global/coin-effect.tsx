...
export const CoinContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[700px] flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-[#0b1338] to-[#101c44] w-screen rounded-md z-0',
        className
      )}
    >
      {/* Fundo Dinâmico com Gradientes e Efeitos */}
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#0b1338] to-[#101c44]"></div>
