...
export default function InvestorSupportPage() {
  ...
  useEffect(() => {
    logger.info("Página de suporte do investidor carregada");
  }, []);
  ...
  const messageHistory = [
    {
      ...
      date: "05/06/2024",
      preview: "Gostaria de entender melhor o cálculo dos rendimentos mensais...",
      status: "resolved"
    },
    {
      id: 2,
      subject: "Documentação para Imposto de Renda",
      date: "15/03/2024",
      preview: "Preciso dos documentos para declaração de IR...",
      status: "resolved"
    }
  ];
      ...
      >
        <GlassCard>
          <CardHeader>
            ...
            <CardDescription>Todas as suas comunicações anteriores</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {messageHistory.map((msg, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="flex justify-between items-start p-4 rounded-lg bg-slate-800/30 border border-slate-700/30 hover:bg-slate-800/40 transition-colors"
                >
                  <div className="flex-1">
